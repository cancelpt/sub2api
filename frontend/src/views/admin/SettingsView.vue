        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <div
                class="rounded-lg border border-gray-200 bg-gray-50/80 p-4 dark:border-dark-600 dark:bg-dark-800/60"
              >
                <div class="flex items-center justify-between">
                  <div>
                    <label
                    ...
                    >
                      {{
                        t(
                          "admin.settings.scheduling.openaiStrictRetryEnabledHint",
                        )
                      }}
                    </p>
                  </div>
                ...
                <div class="mt-4">
                  ...
                  <input
                    ...
                    :disabled="
                      !form.openai_strict_scheduler_enabled ||
                      !form.openai_strict_retry_enabled
                    "
                  />
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
                ...
                <div class="mt-4">
                  ...
                  <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                    {{
                      t(
                        "admin.settings.scheduling.openaiStrictRetryDelayMsHint",
                      )
                    }}
                  </p>
                </div>
